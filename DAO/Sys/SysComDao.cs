...
namespace Js.DAO.Sys
{
    public class SysComDao
    {
        ...
        public bool CreateDataBase(string IP, string strDataBase, string dbPath, string strPath)
        {
            string strdbpath = dbPath;
            if (dbPath.Substring(dbPath.Length - 1) != @"\")
                strdbpath = dbPath + @"\";
            ...
            string strCreateDataBase = "CREATE DATABASE " + strDataBase +
                            ...
                            "( NAME = " + strDataBase + "_dat, " +
                                "FILENAME = '" + strdbpath + strDataBase + ".mdf', " +
                               " SIZE = 10, " +
                                "MAXSIZE = 50, " +
                                "FILEGROWTH = 5 ) " +
                            "LOG ON " +
                            "( NAME =  " + strDataBase + "_log, " +
                             "   FILENAME = '" + strdbpath + strDataBase + ".ldf', " +
                              "  SIZE = 5MB, " +
                               " MAXSIZE = 25MB, " +
                                "FILEGROWTH = 5MB )";
