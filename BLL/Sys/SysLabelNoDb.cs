...
namespace Js.BLL.Sys
{
    public class SysLabelNoDb
    {
        ...
        public SysLabelNoDb(string cnKey)
        {
            dao = new SysLabelDao(cnKey);
        }
        /// <summary>
        ///  测试连接是否成功
        /// </summary>
        ...
        public bool CreateDataBase(string IP, string strSQL, string strPath)
        {
            return dao.CreateDataBase(IP, strSQL, strPath);
        }
