<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductResumesNoCheck.aspx.cs" Inherits="WebUI_Enterprise_ProductResumesNoCheck" %>
...
<head id="Head1" runat="server">
        ...
        <script type='text/javascript'>
            function pEdit() {
                ...
                var  id = "";
                var exist = IsExistsByFilter(formId, $("#ddlEnterpriseID").val(), id, "<%= cnKey%>");
            ...
            function UploadBU() {
                ...
                if (gdview.rows.length > 0) {
                    if ($.trim(getCellValueByRow(17)).length == 0) {
    ...
    <div>
       ...
       <div id="surdiv" style="overflow:auto">
            <table class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#ffffff" border="1">			
					<tr>
						<td  valign="middle" align="left" colspan="5" height="22" class="title1">
			 				<p><asp:Literal ID="ltlTitle" Text="企業用戶產品履歷設定(未認證)" runat="server"></asp:Literal></p>
						</td>
					</tr>
					<tr>
          ...
          <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:TemplateField HeaderText="原廠生產履歷網址"  SortExpression="ResumeOfficalUrl">
                    <ItemTemplate>
