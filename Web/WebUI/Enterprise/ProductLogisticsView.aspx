<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductLogisticsView.aspx.cs" Inherits="WebUI_Enterprise_ProductLogisticsView" %>
    ...
    <title></title>
        ...
        <script type='text/javascript'>
            function pEdit(op) {
                ...
                if (op && FormID == "EP_ProductLogistics") {
                    if (exist == "1") {
                ...
                if (op)
                    location.href = "ProductLogisticsEdit.aspx?FormID=<%= FormID%>&ID=" + id + "";
                else
            ...
            function Modify() {
                ...
                var ID = $("#txtLogisticsID").val();               
                window.showModalDialog('ProductLogisticsModify.aspx?EnterpriseID=' + EnterpriseID + '&ID=' + ID + '&FormID=<% =FormID%>&TitleName=' + TitleName, window, 'dialogHeight:250px;dialogWidth:800px;toolbar=no,status=yes,resizable=no');
                return false;
            }
            function SourceView() {
                var ID = $("#txtLogisticsID").val();
                addTab('../WebUI/Enterprise/ProductLogisticsVIew.aspx?FormID=EP_ProductLogistics&ID=' + ID, '<%=Resources.Resource.EP_ProductLogisticsTabName %>', 'tab_3_10');
                return false;
            }
				...
				border="1" runat="server">			
					<tr>
						<td  valign="middle" align="left" colspan="4" height="22" class="title1">
							<p><asp:Literal ID="ltlTitle" Text="物流資訊查詢[ 單筆明細畫面 ]" runat="server"></asp:Literal></p>
						</td>
					</tr>		
					<tr>
					...
					<tr>
						...
						<td width="35%" >&nbsp;
								<asp:textbox id="txtLogisticsID" runat="server" CssClass="TextRead"  ReadOnly="true"
						...
						<td class="musttitle" align="center" width="15%"><asp:Literal 
                                ...
                                runat="server"></asp:Literal></td>
						<td  width="35%">&nbsp;
								<asp:DropDownList runat="server" ID="ddlArea"  Width="70%" Enabled="false" ></asp:DropDownList>
                            &nbsp;
					...
					<tr>
						...
						<td width="35%"  colspan="3">&nbsp;
								<asp:textbox id="txtProductID" runat="server" CssClass="TextRead"  ReadOnly="true"  Width="37%" MaxLength="20"></asp:textbox>
                        </td>
					...
					<tr>
						...
						<td width="85%" colspan="3" >&nbsp;
								<asp:textbox id="txtProductName" runat="server" CssClass="TextRead"  ReadOnly="true" Width="96%" MaxLength="120"></asp:textbox>
                        </td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td  width="85%" colspan="3">&nbsp;
								<asp:textbox id="txtEPLogisticsID" runat="server" CssClass="TextRead"  ReadOnly="true"  Width="96%" MaxLength="20" 
									 ></asp:textbox>
                         </td>
					</tr>
					<tr>
						...
						<td  width="85%" colspan="3" >&nbsp;
								<asp:textbox id="txtLogisticsOfficalUrl" runat="server" 
                                CssClass="TextRead"  ReadOnly="true" Width="92%" MaxLength="50"></asp:textbox>
                            &nbsp;
                            <asp:HyperLink ID="lnkLogisticsOfficalUrl" Target="_blank" runat="server">Go</asp:HyperLink>
                         </td>
					</tr>					
                     <tr>
