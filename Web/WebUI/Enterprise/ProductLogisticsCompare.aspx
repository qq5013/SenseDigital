<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductLogisticsCompare.aspx.cs" Inherits="WebUI_BusinessUnit_ProductLogisticsCompare" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>產品物流資訊比對記錄查詢</title>
                    ...
                    <table width="100%">
                            <tr>
                                <td style=" font-size:14px;">
                                    ...
                                    <asp:Literal ID="Literal2" Text="物流資訊編號" runat="server"></asp:Literal>
                                     <div style="width:100%;height:304px;overflow:auto;position:absolute;left:0px;top:20px">
                                    <asp:GridView ID="GridView1" SkinID="GridViewSkin" DataKeyNames="LogisticsID" 
                ...
                <td >
                  <div style="width:100%;height:327px;overflow:auto;position:absolute;">
                    <table width="100%">
                        <tr>
                            <td style=" font-size:14px;">                           
                                  <asp:Literal ID="Literal3" Text="原始資料" runat="server"></asp:Literal>
                        ...
                        <tr>
                            <td valign="bottom" style=" font-size:14px;">
                                ...
                                <asp:Literal ID="Literal1" Text="修改後資料" runat="server"></asp:Literal>
                                 <div style="width:100%;height:130px;overflow:auto;">
