<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductsNoCheck.aspx.cs" Inherits="WebUI_Enterprise_ProductsNoCheck" %>
...
//                location.href = "Default.aspx";
            ...
            function UploadBU() {
                ...
                if (gdview.rows.length > 0) {
                    if ($.trim(getCellValueByRow(18)).length == 0) {
            ...
            function getCellValueByRow(rowIndex) {
                var gdview = document.getElementById("<%=GridView1.ClientID %>");
                if (gdview.rows.length > 0)
                    return gdview.rows(1).cells(rowIndex).innerText;
                else
                    return "";
            }
         ...
         <div id="surdiv" style="overflow:auto">
            <table class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#ffffff" border="1">			
					<tr>
						<td  valign="middle" align="left" colspan="5" height="22" class="title1">
			 				<p><asp:Literal ID="ltlTitle" Text="企業用戶產品設定(未認證)" runat="server"></asp:Literal></p>
						</td>
					</tr>
					<tr>
          ...
          <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="產品編號"  SortExpression="ProductID" >
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "ProductView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "ProductID") %>' Text='<%# DataBinder.Eval(Container.DataItem, "ProductID")%>'></asp:HyperLink>                         
                    </ItemTemplate>
                  ...
                  <HeaderStyle Width="12%" Wrap="False" />
                    ...
                    <ItemTemplate>
                         <asp:HyperLink id="HyperLink2" runat="server" Target="_blank" NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "OfficalUrl") %>' >
                            <%# DataBinder.Eval(Container.DataItem, "OfficalUrl")%>
                         </asp:HyperLink>                       
                    </ItemTemplate>
