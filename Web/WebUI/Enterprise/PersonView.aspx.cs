...
public partial class WebUI_BusinessUnit_PersonView : BasePage
{
    ...
    {
        Js.BLL.BaseDal dal = new Js.BLL.BaseDal(FormID, cnKey);       
        DataTable dt = dal.GetEnterpriseRecord("F", this.txtEnterpriseID.Text, this.txtPersonID.Text);
        BindData(dt);
    }
    protected void btnPre_Click(object sender, EventArgs e)
    {
        Js.BLL.BaseDal dal = new Js.BLL.BaseDal(FormID, cnKey);       
        DataTable dt = dal.GetEnterpriseRecord("P", this.txtEnterpriseID.Text, this.txtPersonID.Text);
        if (dt != null)
            BindData(dt);
    }
    ...
    {
        Js.BLL.BaseDal dal = new Js.BLL.BaseDal(FormID, cnKey);       
        DataTable dt = dal.GetEnterpriseRecord("N", this.txtEnterpriseID.Text, this.txtPersonID.Text);
        if (dt != null)
            BindData(dt);
    }
    protected void btnLast_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = dal.GetEnterpriseRecord("L", this.txtEnterpriseID.Text, this.txtPersonID.Text);
        BindData(dt);
    }
    ...
    protected void btnCheck_Click(object sender, EventArgs e)
    {
       ...
       // dal.Update(dr, ID);
        //DataTable dt = dal.GetRecord(ViewState["StrWhere"].ToString());
        dal.Update(dr, this.txtPersonID.Text, "EnterpriseID='" + this.txtEnterpriseID.Text + "'");
        ViewState["StrWhere"] = string.Format(" PersonID='{0}' and EnterpriseID='{1}'", this.txtPersonID.Text, this.txtEnterpriseID.Text);
        DataTable dt = dal.GetRecord(ViewState["StrWhere"].ToString());       
        BindData(dt);
    }
