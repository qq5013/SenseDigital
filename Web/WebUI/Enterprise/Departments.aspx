    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    SkinID="GridViewSkin" Width="1100px" AllowSorting="True"  
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="使用單位編號"  SortExpression="DepartmentID">
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "DepartmentView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "DepartmentID") %>' Text='<%# DataBinder.Eval(Container.DataItem, "DepartmentID")%>'></asp:HyperLink>                                             
                    </ItemTemplate>
                  <ItemStyle Width="12%" Wrap="False" HorizontalAlign="Left"/>
                  <HeaderStyle Width="12%" Wrap="False" />
               </asp:TemplateField>
                <asp:BoundField DataField="DepartmentName" HeaderText="使用單位名稱" 
