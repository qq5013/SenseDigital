...
using System.Data;
public partial class WebUI_Enterprise_ProductLogistics : BasePage
{
    int PageSize = 15;
    ...
    {
        ViewState["strWhere"] = string.Format("EnterpriseID='{0}'", Session["EnterpriseID"].ToString()) + " and " + this.HiddenField1.Value;
        ViewState["CurrentPage"] = 1;
        SetBtnEnabled("");
    }
