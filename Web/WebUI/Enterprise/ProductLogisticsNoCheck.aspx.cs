...
public partial class WebUI_Enterprise_ProductLogisticsNoCheck : BasePage
{
    int PageSize = 15;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            if (cb.Checked)
            {
                ...
                iReturn = sdal.GetBillCanBeEdit(FormID, Session["EnterpriseID"].ToString(), "LogisticsID='" + hk.Text + "'");
                ...
                if (iReturn == 1)
                    ...
                    //dal.Delete(Session["EnterpriseID"].ToString(), "LogisticsID='" + hk.Text + "'");
