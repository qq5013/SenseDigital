...
<head id="Head1" runat="server">
        ...
        <script type="text/javascript" src="../BusinessUnit/Js/Enterprise.js"></script>
            ...
            <table class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#ffffff"	border="1" >			
					...
					<tr>
						...
						<td width="85%"  colspan="3">&nbsp;
								<asp:textbox id="txtEnterpriseName" runat="server" CssClass="TextRead" 
                                Width="96%" MaxLength="100" meta:resourcekey="txtEnterpriseNameResource1" 
                    ...
                    <tr>
						...
						<td width="85%"  colspan="3">&nbsp;
								<asp:textbox id="txtEnterpriseEName" runat="server" CssClass="TextRead" 
                                Width="96%" MaxLength="100" meta:resourcekey="txtEnterpriseENameResource1" 
                                ReadOnly="True"></asp:textbox>
                        </td>
                     ...
                     <tr>
						...
						<td width="85%"  colspan="3">&nbsp;
								<asp:textbox id="txtEnterpriseSName" runat="server" CssClass="TextRead" 
                                Width="96%" MaxLength="40" meta:resourcekey="txtEnterpriseSNameResource1" 
                                ReadOnly="True"></asp:textbox>
                        </td>
                    ...
                    <tr>
						...
						<td width="35%" >&nbsp;
								<asp:textbox id="txtUnionID" runat="server" CssClass="TextRead" Width="90%" 
                                MaxLength="20" meta:resourcekey="txtUnionIDResource1" ReadOnly="True"></asp:textbox>
                        </td>
						...
						<td  width="35%">&nbsp;
                                ...
                                meta:resourcekey="txtPhoneResource1" Width="90%" ReadOnly="True"></asp:TextBox>
                          		</td>
					</tr>
                    <tr>
						<td class="smalltitle" align="center" width="15%" >
						...
						<td width="35%" >&nbsp;
								<asp:textbox id="txtPresident" runat="server" CssClass="TextRead" 
                                Width="90%" MaxLength="20" meta:resourcekey="txtPresidentResource1" 
                                ReadOnly="True"></asp:textbox>
						...
						<td  width="35%">&nbsp;
                                ...
                                meta:resourcekey="txtFaxResource1" Width="90%" ReadOnly="True"></asp:TextBox>
								</td>
					</tr>
                    ...
                    <tr>
						...
						<td width="85%" colspan="3" >&nbsp;
								<asp:textbox id="txtWebUrl" runat="server" CssClass="TextRead" Width="96%" 
                                MaxLength="100" meta:resourcekey="txtWebUrlResource1" ReadOnly="True"></asp:textbox>
                        </td>
					</tr>
                    <tr>
						<td class="smalltitle" align="center">
						...
						<td width="85%" colspan="3">&nbsp;
								<asp:textbox id="txtAddress" runat="server" CssClass="TextRead" Width="80%" 
                                MaxLength="100" meta:resourcekey="txtAddressResource1" ReadOnly="True"></asp:textbox>
                            &nbsp;<asp:TextBox ID="txtZipNo" runat="server" CssClass="TextRead" 
                                MaxLength="5" meta:resourcekey="txtAddressResource1" Width="15%" 
                                ReadOnly="True"></asp:TextBox>
                        </td>
					</tr>
                      ...
                      <tr>
						...
						<td width="35%" >&nbsp;
                                ...
                                MaxLength="20" Width="90%" ReadOnly="True"></asp:TextBox>
								</td>
						<td class="smalltitle" align="center" width="15%">
                ...
                <asp:TextBox ID="txtMemo" runat="server" CssClass="TextRead" 
                        ...
                        Width="98%" Height="300px" meta:resourcekey="txtSubMemoResource2" 
                        ReadOnly="True"></asp:TextBox>
                </div>          
            </div>
        </div>
