...
public partial class WebUI_System_AnnounceMessages : BasePage
{
    int PageSize = 15;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if(Session["UserType"].ToString()=="BU")
                ViewState["strWhere"] = "AnnounceFlag=0";
            else
                ViewState["strWhere"] = string.Format("AnnounceUnitNo='{0}'",Session["EnterpriseID"].ToString());
            SetBtnEnabled("");
            dataSearch();
            //SetPermission();
        }
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                case "0":
                    e.Row.Cells[7].Text = Resources.Resource.AnnounceSource1;
                    break;
                case "1":
                    e.Row.Cells[7].Text = Resources.Resource.AnnounceSource2;
                    break;
            }            
        }
    }
