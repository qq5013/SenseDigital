<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnnounceMessages.aspx.cs" Inherits="WebUI_System_AnnounceMessages" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="公告ID"  SortExpression="AnnounceID">
                    ...
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "AnnounceMessageView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "AnnounceID") %>' Text='<%# DataBinder.Eval(Container.DataItem, "AnnounceID") %>'></asp:HyperLink>                       
                    </ItemTemplate>
               ...
               <asp:BoundField DataField="AnnounceDate" HeaderText="發佈日期" HtmlEncode="false" DataFormatString="{0:yyyy/MM/dd HH:mm}"
                ...
                <asp:BoundField DataField="AnnounceUnitNo" HeaderText="發佈單位編號" 
                    SortExpression="AnnounceUnitNo">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
