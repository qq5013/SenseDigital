<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Members.aspx.cs" Inherits="WebUI_Customer_Members" %>
    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="會員ID"  SortExpression="MemberID">
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "MemberView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "MemberID") %>' Text='<%# DataBinder.Eval(Container.DataItem, "MemberID")%>'></asp:HyperLink>                       
                    </ItemTemplate>
...
<%--                <asp:BoundField DataField="Password" HeaderText="密碼" 
                ...
                <asp:BoundField DataField="PasswordHint" HeaderText="密碼提示" 
                    SortExpression="PasswordHint">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>--%>
                ...
                <asp:BoundField DataField="Sex" HeaderText="性別" 
                 ...
                 <asp:BoundField DataField="SpareEMail" HeaderText="備用郵件" 
                    SortExpression="SpareEMail" >
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="LinkPhone" HeaderText="聯絡電話" 
                    SortExpression="LinkPhone">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>            
                <asp:BoundField DataField="Address1" HeaderText="通訊地址1" 
                    SortExpression="Address1">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Address2" HeaderText="通訊地址2" 
                    SortExpression="Address2">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="個人網站"  SortExpression="WebSite">
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink2" runat="server" Target="_blank"                            
                            NavigateUrl='<%# "http://" + DataBinder.Eval(Container.DataItem, "WebSite") %>'><%# DataBinder.Eval(Container.DataItem, "WebSite")%></asp:HyperLink>                       
                    </ItemTemplate>
                  <ItemStyle Width="12%" Wrap="False" />
                  <HeaderStyle Width="12%" Wrap="False" />
               </asp:TemplateField>
               <asp:BoundField DataField="CreateDate" HeaderText="創建日期" HtmlEncode="false" DataFormatString="{0:yyyy/MM/dd HH:mm}"
