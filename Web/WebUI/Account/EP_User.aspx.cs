...
public partial class WebUI_Account_EP_User : BasePage
{
    protected string FormID;
    protected bool IsEdit = false;
    protected int UserID;
    protected string NodeUser = "supervisor";
    DataTable dtUser;
    ...
    private void BindGrid()
    {
        ...
        //父級用戶權限
        DataTable dt;
        if (ViewState["ParentUserName"].ToString().ToLower() == "supervisor" || ViewState["ParentUserName"].ToString() == "")
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                ddl.SelectedValue = UserPermission.Substring(0, 1);
                if (IsRole)
                    ddl.Enabled = false;
                else
                    ddl.Enabled = IsEdit;
            ...
            {
                ddl.SelectedValue = UserPermission.Substring(1, 1);
                if (IsRole)
                    ddl.Enabled = false;
                else
                    ddl.Enabled = IsEdit;
            ...
            {
                ddl.SelectedValue = UserPermission.Substring(2, 1);
                if (IsRole)
                    ddl.Enabled = false;
                else
                    ddl.Enabled = IsEdit;
            ...
            {
                ddl.SelectedValue = UserPermission.Substring(3, 1);
                if (IsRole)
                    ddl.Enabled = false;
                else
                    ddl.Enabled = IsEdit;
            ...
            {
                ddl.SelectedValue = UserPermission.Substring(4, 1);
                if (IsRole)
                    ddl.Enabled = false;
                else
                    ddl.Enabled = IsEdit;
            ...
            {
                ddl.SelectedValue = UserPermission.Substring(5, 1);
                if (IsRole)
                    ddl.Enabled = false;
                else
                    ddl.Enabled = IsEdit;
            ...
            {
                ddl.SelectedValue = UserPermission.Substring(6, 1);
                if (IsRole)
                    ddl.Enabled = false;
                else
                    ddl.Enabled = IsEdit;
            ...
            {
                ddl.SelectedValue = UserPermission.Substring(7, 1);
                if (IsRole)
                    ddl.Enabled = false;
                else
                    ddl.Enabled = IsEdit;
            ...
            {
                ddl.SelectedValue = UserPermission.Substring(8, 1);
                if (IsRole)
                    ddl.Enabled = false;
                else
                    ddl.Enabled = IsEdit;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            if (ddl != null)
            {
                Permissions += ddl.SelectedValue.ToString();
                ddl.Enabled = false;
            }
            else
                Permissions = "0";
