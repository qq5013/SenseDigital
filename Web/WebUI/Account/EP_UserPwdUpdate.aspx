<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EP_UserPwdUpdate.aspx.cs" Inherits="WebUI_Account_EP_UserPwdUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function Save() {
            ...
            var exist = ConfirmPwd('<%=Session["User"] %>', $("#txtOldPassword").val(),'<%=cnKey %>');
            if (!exist) {
...
<body>
    ...
    <table style="width: 100%; height: 20px;" class="OperationBar">
        ...
        <table class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#ffffff" border="1" >	
                    <tr>
						<td class="musttitle" align="center" width="20%" ><asp:Literal ID="ltlEnterpriseID" Text="企業編號"
                                runat="server"></asp:Literal>
                        </td>
						<td width="80%" >&nbsp;
								<asp:DropDownList ID="ddlEnterpriseID" runat="server" AutoPostBack="True" 
                                onselectedindexchanged="ddlEnterpriseID_SelectedIndexChanged" Width="50%">
                            </asp:DropDownList>
                        </td>
