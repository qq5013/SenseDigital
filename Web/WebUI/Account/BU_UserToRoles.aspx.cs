...
public partial class WebUI_Account_BU_UserToRoles : BasePage
{
    int PageSize = 15;
    ...
    {
        //Js.BLL.Account.UserDal user = new Js.BLL.Account.UserDal(Context.User.Identity.Name);
        //string Permission = user.GetUserPermissionByFormID(FormID);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            switch (int.Parse(e.Row.Cells[4].Text) % 1000)
            {
                case 0:
                    e.Row.Cells[4].Text = Resources.Resource.UserLevel1;
                    break;
                default:
                    e.Row.Cells[4].Text = Resources.Resource.UserLevel2;
                    break;
            }
        }
    }
