<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EP_User.aspx.cs" Inherits="WebUI_Account_EP_User" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Add() {
            location.href = "EP_UserEdit.aspx?FormID=<% =FormID %>&NodeUser=<% =NodeUser%>";
            return false;
        }
        function eEdit() {
            var user = $("#txtUserName").val();
            location.href = "EP_UserEdit.aspx?FormID=<% =FormID %>&UserName=" + user + "&NodeUser=" + user;
            return false;
        }
        function Cancel() {
                ...
                <td valign="top" width="85%">
                    ...
                    <tr>
                        <td class="smalltitle" align="center" >
                            <asp:Literal ID="ltlUserLevel0" runat="server" Text="企業編號"></asp:Literal>
                        </td>
                        <td colspan="5">
                            &nbsp;
                            <asp:DropDownList ID="ddlEnterpriseID" runat="server" AutoPostBack="True" 
                                onselectedindexchanged="ddlEnterpriseID_SelectedIndexChanged" Width="96%">
                            </asp:DropDownList>
                            &nbsp;</td>                       
                    </tr>
					<tr>
