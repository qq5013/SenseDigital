<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BU_RoleToUserEdit.aspx.cs" Inherits="WebUI_Account_BU_RoleToUserEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function AssignUser() {
            ...
            location.href = "BU_RoleToUserEdit.aspx?RoleID=" + roleID
        }
        ...
        function Save() {
            ...
            if (!haveCheck) 
                alert("<%=Resources.Resource.RoleToUser_NotUser %>");                
            return haveCheck
        }
    </script>
</head>
    ...
    <table style="width: 100%; height: 20px;" class="OperationBar">
        ...
        <table class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#ffffff" border="1" >			
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="UserID"
                    SkinID="GridViewSkin" Width="800px" OnRowDataBound="GridView1_RowDataBound">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
