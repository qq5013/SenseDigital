<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BU_RoleToUsers.aspx.cs" Inherits="WebUI_Account_BU_RoleToUsers" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript'>
        ...
        function Assign() {
            location.href = "BU_RoleToUserEdit.aspx?FormID=<%= FormID%>&RoleID=";
        }
    </script>
</head>
<body >
    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    SkinID="GridViewSkin" Width="600px" AllowSorting="True"  
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="角色ID"  SortExpression="RoleID">
                    ...
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "BU_RoleToUserView.aspx?FormID=" + FormID + "&RoleID="+DataBinder.Eval(Container.DataItem, "RoleID") %>' Text='<%# DataBinder.Eval(Container.DataItem, "RoleID")%>'></asp:HyperLink>                       
                    </ItemTemplate>
