<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductionUnits.aspx.cs" Inherits="WebUI_Label_ProductionUnits" %>
    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="單位編號"  SortExpression="ProductionUnitID" 
                    >
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            
                            NavigateUrl='<%# "ProductionUnitView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "ProductionUnitID") %>' 
                            Text='<%# DataBinder.Eval(Container.DataItem, "ProductionUnitID") %>'></asp:HyperLink>                       
                    </ItemTemplate>
                  <ItemStyle Width="8%" Wrap="False" HorizontalAlign="Left"/>
                  <HeaderStyle Width="8%" Wrap="False" />
               </asp:TemplateField>
                <asp:BoundField DataField="ProductionUnitName" HeaderText="生產單位名稱" 
                    SortExpression="ProductionUnitName">
