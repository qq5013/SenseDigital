<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturnLabel.aspx.cs" Inherits="WebUI_Label_ReturnLabel" %>
    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="退貨單號"  SortExpression="BillID">
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "ReturnLabelView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "BillID") %>'><%# DataBinder.Eval(Container.DataItem, "BillID")%></asp:HyperLink>                       
                    </ItemTemplate>
                ...
                <asp:BoundField DataField="CreateUserName" HeaderText="建檔人員" 
                    SortExpression="CreateUserName" meta:resourcekey="BoundFieldResource16">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="CheckDate" HeaderText="企業覆核日期" HtmlEncode="false" DataFormatString="{0:yyyy/MM/dd HH:mm}"
                    SortExpression="CheckDate">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="CheckUserName" HeaderText="企業覆核人員" 
                ...
                <asp:BoundField DataField="CheckUserName" HeaderText="營運覆核人員" 
                    SortExpression="CheckUserName">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
