<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderView.aspx.cs" Inherits="WebUI_Label_OrderView" %>
        ...
        function initial() {
            ...
            $("#btnImageQuery").bind("click",
                function () {
                    ...
                    window.showModalDialog('ImageQuery.aspx?BillID=' + $("#txtBillID").val() + '&Flag=1&ID=' + strReturn, null, 'DialogHeight:280px;DialogWidth:600px;help:no;scroll:no'); //shj
                    return false;
                });
                $("#btnEstimate").bind("click", function () {
                    ...
                    $("#HdnSubDetail1").val("" + obj[0].parentNode.parentNode.cells[1].innerHTML);
                    return strReturn;
                });
            ...
            if (obj && obj.length > 0) {
                ...
                if ("" + toNumber($("#HdnSubDetail1").val()) == "NaN")
                    obj[0].checked = true;
                else
                    obj[toNumber($("#HdnSubDetail1").val()) - 1].checked = true;
            }
        }
    </script>
</head>
            ...
            <div id="surdiv" style="overflow: auto">
                <table class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center"
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;
                            <asp:TextBox ID="txtCustomerPO" runat="server" CssClass="TextRead" ReadOnly="true"
                                Width="90%" MaxLength="20" Height="16px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <td align="center" class="smalltitle">
                                <asp:Literal ID="ltlBillState" runat="server" Text="單況"></asp:Literal>
                            </td>
                            <td>
                                ...
                                <asp:Button ID="btnBillState" runat="server" CssClass="but" Text=" 單況切換" 
                                    Width="75px" onclick="btnBillState_Click" />
                            </td>
                    </tr>
                    <tr>
                        <td class="smalltitle" align="center">
                            <asp:Literal ID="ltlContact" runat="server" Text="聯絡人員"></asp:Literal>
                        </td>
                        <td>
                            &nbsp;&nbsp;<asp:TextBox ID="txtContact" runat="server" CssClass="TextRead" ReadOnly="true"
                                Width="90%" MaxLength="20"></asp:TextBox>
                        </td>
                        <td class="smalltitle" align="center">
                            <asp:Literal ID="ltlContactPhone" runat="server" Text="聯絡電話"></asp:Literal>
                        </td>
                        <td>
                            &nbsp;&nbsp;
                            <asp:TextBox ID="txtContactPhone" runat="server" CssClass="TextRead" MaxLength="20"
                                ReadOnly="true" Width="90%"></asp:TextBox>
                        </td>
                        <td align="center" class="smalltitle">
                            <asp:Literal ID="ltlFax" runat="server" Text="傳真號碼"></asp:Literal>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="smalltitle" align="center">
                            <asp:Literal ID="ltlDeliverAddress" runat="server" Text="送貨地址"></asp:Literal>
                        </td>
                        <td colspan="3">
                            &nbsp;
                            <asp:TextBox ID="txtDeliverCountry" runat="server" CssClass="TextRead" MaxLength="20"
                                ReadOnly="true" Width="30%">
                            </asp:TextBox>
                            &nbsp;<asp:TextBox ID="txtDeliverAddress" runat="server" CssClass="TextRead" MaxLength="20"
                                ReadOnly="true" Width="65%">
                            </asp:TextBox>
                        </td>
                        <td class="smalltitle" align="center">
                            <asp:Literal ID="ltlDeliverMehtod" runat="server" Text="交貨方式"></asp:Literal>
                        </td>
                        <td>
                            &nbsp;
                            <asp:TextBox ID="txtDeliverMehtod" runat="server" CssClass="TextRead" MaxLength="20"
                                ReadOnly="true" Width="90%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            &nbsp;
                            <asp:TextBox ID="txtBusPersonID" runat="server" CssClass="TextRead" MaxLength="20"
                                ReadOnly="true" Width="30%">
                            </asp:TextBox>
                        ...
                        <td colspan="2">
                            &nbsp;
                            <asp:Button ID="btnCancelOrdNo" runat="server" Text=" 取消數量" CssClass="but" Width="75px"
                                OnClick="btnOrdPreNO_Click"></asp:Button>
                            &nbsp;<asp:Button ID="btnOrdPreNO" runat="server" Text=" 交期異動" CssClass="but" Width="75px"
                                OnClick="btnOrdPreNO_Click"></asp:Button>
                        ...
                        <div style="overflow: auto; width: 100%; height: 150px">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SkinID="GridViewSkin"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="訂購張數" SortExpression="Pages">
                                        <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="IsGift" HeaderText="贈品" SortExpression="IsGift">
                                        <ItemStyle HorizontalAlign="Center" Width="8%" Wrap="False" />
                                        <HeaderStyle Wrap="False" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="(取消張數)" SortExpression="CancelPages">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "CancelPages", "{0:N0}")%>
                                        </ItemTemplate>
                                        <HeaderStyle Wrap="False" />
                                        <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="(未交張數)" SortExpression="NoDeliverPages">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "NoDeliverPages", "{0:N0}")%>
                                        </ItemTemplate>
                                        <HeaderStyle Wrap="False" />
                                        <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="IsClose" HeaderText="(結案)" SortExpression="IsClose">
                                        <ItemStyle HorizontalAlign="Center" Width="8%" Wrap="False" />
                                        <HeaderStyle Wrap="False" />
                                    </asp:BoundField>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtMemo" runat="server" CssClass="TextRead" ReadOnly="true" TextMode="MultiLine"
                                        Width="98%" Height="148"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
