<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Warehouses.aspx.cs" Inherits="WebUI_Label_Warehouses" %>
    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="倉庫編號"  SortExpression="WarehouseID" 
                    >
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            
                            NavigateUrl='<%# "WarehouseView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "WarehouseID") %>' 
                            Text='<%# DataBinder.Eval(Container.DataItem, "WarehouseID") %>'></asp:HyperLink>                       
                    </ItemTemplate>
                  <ItemStyle Width="8%" Wrap="False" HorizontalAlign="Left"/>
                  <HeaderStyle Width="8%" Wrap="False" />
               </asp:TemplateField>
                <asp:BoundField DataField="WarehouseName" HeaderText="倉庫名稱" 
                ...
                <asp:BoundField DataField="Contact" HeaderText="連絡人" 
                  ...
                  <asp:BoundField DataField="ContactPhone" HeaderText="連絡電話" 
                    SortExpression="ContactPhone" >
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                  <asp:BoundField DataField="Address" HeaderText="倉庫地址" 
