<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherBatchActionEdit.aspx.cs" Inherits="WebUI_Label_OtherBatchActionEdit" %>
...
<head id="Head1" runat="server">
    <title></title>
     <link href="~/Styles/Main.css" type="text/css" rel="stylesheet" /> 
        ...
        <script type="text/javascript" src="Js/OtherBatchAction.js"></script>
        ...
        <script type="text/javascript">
            ...
            function Load() {
                ...
                var strReturn = window.showModalDialog('OtherBatchActionLoad.aspx', window, 'DialogHeight:330px;DialogWidth:800px;help:no;scroll:no');
                return false;
            }
        </script>
				...
				border="1" runat="server">			
					<tr>
						<td  valign="middle" align="left" colspan="6" height="22" class="title1">
							<p><asp:Literal ID="ltlTitle" Text="標籤其他異動批次作業[ 單筆編輯畫面 ]" runat="server"></asp:Literal></p>
						</td>
					</tr>							
					...
					<tr>
						...
						<td width="25%"  colspan="2">&nbsp;
								<asp:textbox id="txtApplyBillID" runat="server" CssClass="TextBox"   Width="90%" MaxLength="20"></asp:textbox>
                        </td>
						<td  align="center" width="35%">
                                 <asp:button id="btnLoad" runat="server" Text="載入單據"  CssClass="but" Width="80px" OnClientClick="return Load()"></asp:button>
                        </td>
					...
					<tr>
                        ...
                        <td align="center" width="10%" class="musttitle">
                          ...
                          <asp:DropDownList runat="server" ID="ddlApplyUnit"  Width="90%"></asp:DropDownList>
                        </td>		
                        <td>
                                 &nbsp;</td>				
					</tr> 
