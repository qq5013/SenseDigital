...
public partial class WebUI_Label_OtherBatchAction : BasePage
{
    int PageSize = 15;
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                case "0":
                    e.Row.Cells[3].Text = "企業用戶";
                    break;
                case "1":
                    e.Row.Cells[3].Text = "營運單位";
                    break;
                case "2":
                    e.Row.Cells[3].Text = "客服申訴";
                    break;
            }
            switch (e.Row.Cells[6].Text)
            {
                case "Flase":
                    e.Row.Cells[6].Text = "未執行";
                    break;
                case "True":
                    e.Row.Cells[6].Text = "已執行";
                    break;
            }
        }
    }
