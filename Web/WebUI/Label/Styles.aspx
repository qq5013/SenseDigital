<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Styles.aspx.cs" Inherits="WebUI_Label_Styles" %>
        ...
        <ContentTemplate>
                ...
                <table style="width: 100%; height: 20px;" class="OperationBar">
                    <tr>
                        <td align="right">
                            ...
                            <asp:Button ID="btnDelete" runat="server" Text="刪除" CssClass="ButtonDel" OnClick="btnDelete_Click"
                                OnClientClick="return Delete()" meta:resourcekey="btnDeleteResource2" />
            ...
            <div id="table-container" style="overflow: auto; width: 100%; height: 400px">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SkinID="GridViewSkin"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="款式編號" SortExpression="StyleID">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "StyleView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "StyleID") %>'
                                    Text='<%# DataBinder.Eval(Container.DataItem, "StyleID")%>'></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle Width="12%" Wrap="False" />
                            <HeaderStyle Width="12%" Wrap="False" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="StyleName" HeaderText="款式名稱" SortExpression="StyleName">
                            <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                            <HeaderStyle Wrap="False" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="大卷卷數" SortExpression="Volumes">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "Volumes", "{0:N0}")%>
                            </ItemTemplate>
                            <HeaderStyle Wrap="False" />
                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="每卷張數" SortExpression="StdPages">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "StdPages", "{0:N0}")%>
                            </ItemTemplate>
                            <HeaderStyle Wrap="False" />
                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="使用年限" SortExpression="ServiceYears">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "ServiceYears", "{0:N0}")%>
                            </ItemTemplate>
                            <HeaderStyle Wrap="False" />
                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="啟用期限" SortExpression="EnableMonths">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "EnableMonths", "{0:N0}")%>
                            </ItemTemplate>
                            <HeaderStyle Wrap="False" />
                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="ImageLocation" HeaderText="圖象定位" SortExpression="ImageLocation">
                            <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                            <HeaderStyle Wrap="False" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ProductionNo" HeaderText="生產規格書編號" SortExpression="ProductionNo">
                            <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                            <HeaderStyle Wrap="False" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="現有卷數" SortExpression="NowVolumes">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "NowVolumes", "{0:N0}")%>
                            </ItemTemplate>
                            <HeaderStyle Wrap="False" />
                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="現有張數" SortExpression="NowPages">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "NowPages", "{0:N0}")%>
                            </ItemTemplate>
                            <HeaderStyle Wrap="False" />
                            <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="CreateDate" HeaderText="建檔日期" HtmlEncode="false" DataFormatString="{0:yyyy/MM/dd}"
                        ...
                        <asp:BoundField DataField="LastModifyDate" HeaderText="異動日期" HtmlEncode="false" DataFormatString="{0:yyyy/MM/dd}"
                        ...
                        <asp:BoundField DataField="CheckDate" HeaderText="營運覆核日期" HtmlEncode="false" DataFormatString="{0:yyyy/MM/dd HH:mm}"
            ...
            <div>
                ...
                &nbsp;<asp:TextBox ID="txtPageNo" onkeypress="return regInput(this,/^\d+$/,String.fromCharCode(event.keyCode))"
                    ...
                    Width="56px" CssClass="TextBox" meta:resourcekey="txtPageNoResource2"></asp:TextBox>&nbsp;<asp:LinkButton
