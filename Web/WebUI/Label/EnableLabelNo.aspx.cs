...
public partial class WebUI_Label_EnableLabelNo : BasePage
{
    int PageSize = 15;
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                case "0":
                    e.Row.Cells[5].Text = "未上架";
                    break;
                case "1":
                    e.Row.Cells[5].Text = "異常待修正";
                    break;
                case "2":
                    e.Row.Cells[5].Text = "檢查OK";
                    break;
                case "3":
                    e.Row.Cells[5].Text = "上架中";
                    break;
                case "4":
                    e.Row.Cells[5].Text = "已上架";
                    break;
            }
        }
    }
