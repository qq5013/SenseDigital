...
public partial class WebUI_Label_Styles : BasePage
{
    int PageSize = 15;
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            switch (e.Row.Cells[5].Text.ToString())
            {
                case "0":
                    e.Row.Cells[5].Text = Resources.Resource.LB_VerificationMode0;
                    break;
                case "1":
                    e.Row.Cells[5].Text = Resources.Resource.LB_VerificationMode1;
                    break;
            }
        }
        ...
        for (int i = 0; i < this.GridView1.Rows.Count; i++)
        {
            ...
            if (cb.Checked)
            {
                ...
                else
                {
                    ...
                    ddal.DeleteWarehousePagesByStyleID(hk.Text);
                }
            }
        }
        SetBtnEnabled("");
