<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturnLabelView.aspx.cs" Inherits="WebUI_Label_ReturnLabelView" %>
				...
				border="1">			
					<tr>
						<td  valign="middle" align="left" colspan="2" height="22" class="title1">
							<p><asp:Literal ID="ltlTitle" Text="標籤退貨作廢作業[ 單筆明細畫面 ]" runat="server"></asp:Literal></p>
						</td>
					</tr>							
           ...
           <div style="height:200px">
            ...
            <Columns>                
                ...
                <asp:BoundField DataField="styleID" HeaderText="(款式編號)" 
                  ...
                  <asp:BoundField DataField="State" HeaderText="(檢查狀態)" 
                  ...
                  <tr>
                    ...
                    <tr>
						...
						<td width="40%">&nbsp;
                                ...
                                MaxLength="20" ReadOnly="True"></asp:textbox>&nbsp;
                                <asp:button id="Button2" runat="server" Text="執行退貨作廢"  CssClass="but" Width="80px"  ></asp:button>
                                 </td>
					</tr>
                    <tr>
