<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherBatchActionLoad.aspx.cs" Inherits="WebUI_Label_OtherBatchActionLoad" %>
    ...
    <div>
     <table style="font-size: 9pt;" cellspacing="0" cellpadding="0" width="100%" align="center"   >
                     ...
                     <div>
                         ...
                         <div id="div_Detail1" class="fakeContainer" style=" margin:5px;height:230px;">
                         </div>
