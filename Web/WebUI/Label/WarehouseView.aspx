<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WarehouseView.aspx.cs" Inherits="WebUI_Label_WarehouseView" %>
				...
				border="1" runat="server">			
					<tr>
						<td  valign="middle" align="left" colspan="4" height="22" class="title1">
							<p><asp:Literal ID="ltlTitle" Text="倉庫資料設定[ 單筆明細畫面 ]" runat="server"  ></asp:Literal></p>
						</td>
					</tr>				
					...
					<tr>
						...
						<td width="35%" >&nbsp;
								<asp:textbox id="txtWarehouseID" runat="server" CssClass="TextRead"  ReadOnly="true"
						...
						<td  width="35%">&nbsp;
								<asp:textbox id="txtWarehouseName" runat="server" CssClass="TextRead"  ReadOnly="true" Width="90%" 
						...
						<td  width="35%">&nbsp;
								<asp:textbox id="txtContactPhone" runat="server" CssClass="TextRead"  ReadOnly="true" Width="90%" 
                                MaxLength="20" ></asp:textbox>
                        </td>
					</tr>
					<tr>
						...
						<td width="85%" colspan="3" >&nbsp;
								<asp:textbox id="txtAddress" runat="server" CssClass="TextRead"  ReadOnly="true"
