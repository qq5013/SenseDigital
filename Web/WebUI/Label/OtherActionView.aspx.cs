...
public partial class WebUI_Label_OtherActionView : BasePage
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                case "0":
                    e.Row.Cells[4].Text = Resources.Resource.Enterprise;
                    break;
                case "1":
                    e.Row.Cells[4].Text = Resources.Resource.BusinessUnit;
                    break;
                case "2":
                    e.Row.Cells[4].Text = Resources.Resource.CustomerComplaints;
                    break;
            }
        }
    }
