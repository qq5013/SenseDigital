...
function initialTable() {
    ...
    row = new Object();
    row.RowID = "label";
    row.ID = "type=\"text\" maxlength=\"10\"";
    row.StartID = "type=\"text\" maxlength=\"10\"";
    row.EndID = "type=\"text\" maxlength=\"10\"";
    row.Qty = "type=\"text\" maxlength=\"10\"";
    row.Piece = "type=\"text\" maxlength=\"10\"";
    row.APiece = "type=\"text\" maxlength=\"10\"";
    row.Numeber = "type=\"text\" maxlength=\"10\"";
    row.qq = "type=\"text\" maxlength=\"10\"";
    row.State = "type=\"text\" maxlength=\"10\"";
    row.No = "type=\"text\" maxlength=\"10\"";
    row.Date = "type=\"text\" maxlength=\"10\"";
    row.ProductID = "type=\"text\" maxlength=\"10\"";
    row.ProductName = "type=\"text\" maxlength=\"10\"";
    row.No1 = "type=\"text\" maxlength=\"10\"";
    row.No2 = "type=\"text\" maxlength=\"10\"";
    tbColType.push(row);
}
