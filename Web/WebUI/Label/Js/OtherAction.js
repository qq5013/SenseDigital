...
function initialTable() {
    ...
    row = new Object();
    row.SubID = "label";
    row.LabellNo = "type=\"text\" maxlength=\"20\"";
    row.ActionReason = "type=\"text\" maxlength=\"100\"";
    row.StateID = "type=\"text\"  readonly=\"true\"  maxlength=\"2\"";
    row.ApplyUnit = "type=\"text\" maxlength=\"20\"";
    row.ApplyBillID = "type=\"text\" maxlength=\"20\"";
    row.NewStateID = "type=\"text\" maxlength=\"2\"";   
    tbColType.push(row);
}
