...
public partial class WebUI_Label_OtherBatchActionEdit : BasePage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        dr["ApplyBillID"] = this.txtApplyBillID.Text.Trim();
        dr["ApplyUnit"] = this.ddlApplyUnit.SelectedValue;
        ...
        Response.Redirect("OtherBatchActionView.aspx?FormID=" + Server.UrlEncode(FormID) + "&ID=" + Server.UrlEncode(this.txtBillID.Text));
    }
}