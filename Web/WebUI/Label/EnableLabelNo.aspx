<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnableLabelNo.aspx.cs" Inherits="WebUI_Label_EnableLabelNo" %>
    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="啟用單號"  SortExpression="BillID" 
                    meta:resourcekey="TemplateFieldResource4">
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "EnableLabelNoView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "BillID") %>'><%# DataBinder.Eval(Container.DataItem, "BillID")%></asp:HyperLink>                       
                    </ItemTemplate>
                  <ItemStyle Width="12%" Wrap="False" />
                  <HeaderStyle Width="12%" Wrap="False" />
               </asp:TemplateField>
<asp:BoundField DataField="EnableDate" HeaderText="啟用日期" HtmlEncode="false" DataFormatString="{0:yyyy/MM/dd HH:mm}" SortExpression="EnableDate" > 
...
<asp:BoundField DataField="BillState" HeaderText="狀態" SortExpression="BillState" > 
<ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
</asp:BoundField>  
<asp:BoundField DataField="QtyTotal" HeaderText="數量合計" SortExpression="QtyTotal" > 
<ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
</asp:BoundField>  
...
<asp:BoundField DataField="BU_CheckUserName" HeaderText="營運覆核人員" SortExpression="BU_CheckUserName" > 
<ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
</asp:BoundField>  
       ...
       &nbsp;<asp:textbox id="txtPageNo" onkeypress="return regInput(this,/^\d+$/,String.fromCharCode(event.keyCode))"
					    ...
					    runat="server" Width="56px" CssClass="Textread" ReadOnly="true" meta:resourcekey="txtPageNoResource2"></asp:textbox>&nbsp;<asp:linkbutton 
