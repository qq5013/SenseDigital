...
public partial class WebUI_Label_ScheduleEdit : BasePage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        dr["CustomerPO"] ="";//客戶PO 
        dr["EnterpriseID"] = "";//企業用戶編號 
        dr["EnterpriseName"] = "";//企業用戶名稱 
        dr["Contact"] = "";//連絡人員 
        dr["ContactPhone"] ="";//聯絡電話 
        dr["Fax"] = "";//公司傳真 
        dr["BusPersonID"] = "";//業務員編號 
        dr["BusPersonName"] = "";//業務員姓名 
        dr["BillState"] = ddlBillState.SelectedIndex;//單況  0:有效 1:結案 
        dr["DeliverCountry"] = "";//送貨地址國別 
        dr["DeliverAddress"] = "";//送貨地址 
        dr["DeliverMehtod"] = "";//交貨方式 
        ...
        Response.Redirect("ScheduleView.aspx?FormID=" + Server.UrlEncode(FormID) + "&ID=" + Server.UrlEncode(this.txtBillID.Text));
    }
