<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnableLabelNoStockToID.aspx.cs" Inherits="WebUI_Label_EnableLabelNoStockToID" %>
...
<head id="Head1" runat="server">
   <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <title>入庫序號轉入啟用</title> 
        ...
        <script type="text/javascript" src="Js/EnableLabelNoStockToID.js"></script>
...
<body>
    ...
    <div>
     <table style="font-size: 9pt;" cellspacing="0" cellpadding="0" width="100%" align="center"   >
                        ...
                        <tr>
                     <td align="center"><asp:Literal ID="Literal2" Text="入庫單號:"
                                runat="server"></asp:Literal></td>
                                ...
                                Width="80%" MaxLength="20" ReadOnly="true"></asp:textbox><asp:button id="btnCheck3" runat="server" Text=" 指定" 
                                            CssClass="but" Width="50px"  
                                        >
                                    </asp:button></td><td>&nbsp; 
