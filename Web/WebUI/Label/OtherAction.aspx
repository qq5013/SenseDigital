<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherAction.aspx.cs" Inherits="WebUI_Label_OtherAction" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="異動單號"  SortExpression="BillID">
                    ...
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "OtherActionView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "BillID") %>'><%# DataBinder.Eval(Container.DataItem, "BillID")%></asp:HyperLink>                       
                    </ItemTemplate>
