<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Schedules.aspx.cs" Inherits="WebUI_Label_Schedules" %>
        ...
        <ContentTemplate>
            ...
            <div id="table-container" style="overflow: auto; width: 100%; height: 400px">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SkinID="GridViewSkin"
                    Width="1000px" AllowSorting="True" OnSorting="GridView1_Sorting" meta:resourcekey="GridView1Resource2"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="單號" SortExpression="BillID">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ScheduleView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "BillID") %>'
