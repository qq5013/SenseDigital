...
public partial class WebUI_Label_ReturnLabelEdit : BasePage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("ReturnLabelView.aspx?FormID=" + Server.UrlEncode(FormID) + "&ID=" + Server.UrlEncode(this.txtBillID.Text));
    }
}