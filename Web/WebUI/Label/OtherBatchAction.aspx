<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherBatchAction.aspx.cs" Inherits="WebUI_Label_OtherBatchAction" %>
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <Columns>
                <asp:TemplateField meta:resourcekey="TemplateFieldResource3">
                 ...
                 <asp:TemplateField HeaderText="異動單號"  SortExpression="BillID">
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "OtherBatchActionView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "BillID") %>'><%# DataBinder.Eval(Container.DataItem, "BillID")%></asp:HyperLink>                       
                    </ItemTemplate>
