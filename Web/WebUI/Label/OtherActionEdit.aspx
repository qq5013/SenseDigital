<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherActionEdit.aspx.cs" Inherits="WebUI_Label_OtherActionEdit" %>
...
<head runat="server">
    <title></title>
     <link href="~/Styles/Main.css" type="text/css" rel="stylesheet" /> 
        ...
        <script type="text/javascript" src="Js/OtherAction.js"></script>
				...
				border="1" runat="server">			
					<tr>
						<td  valign="middle" align="left" colspan="4" height="22" class="title1">
							<p><asp:Literal ID="ltlTitle" Text="標籤其他異動作業[ 單筆編輯畫面 ]" runat="server"></asp:Literal></p>
						</td>
					</tr>							
						
					<tr>
						<td class="musttitle" align="center" width="10%" ><asp:Literal ID="ltlBillID" Text="異動單號"
						...
						<td  width="20%" align="center">
								  <asp:button id="Button1" runat="server" Text="上傳檔案"  CssClass="but" Width="80px" OnClientClick="return Open()" ></asp:button>&nbsp;
                        </td>
					</tr>
					...
					<tr>
						...
						<td width="70%"  colspan="2">&nbsp;
                                ...
                                &nbsp;<asp:textbox id="txtEnterpriseName" runat="server" CssClass="TextRead"  ReadOnly="true" Width="68%" MaxLength="100"></asp:textbox>
                        </td>
                        <td align="center">
                             <asp:button id="Button2" runat="server" Text="資料匯入"  CssClass="but" Width="80px" ></asp:button>&nbsp;
                        </td>						
					</tr>                 
