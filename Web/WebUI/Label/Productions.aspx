<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Productions.aspx.cs" Inherits="WebUI_Label_Productions" %>
...
<body >
    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="生產單號"  SortExpression="BillID" 
                    meta:resourcekey="TemplateFieldResource4">
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "ProductionView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "BillID") %>' Text='<%# DataBinder.Eval(Container.DataItem, "BillID")%>'></asp:HyperLink>                       
                    </ItemTemplate>
                  <ItemStyle Width="12%" Wrap="False" />
                  <HeaderStyle Width="12%" Wrap="False" />
               </asp:TemplateField>
               <asp:BoundField DataField="BillDate" HeaderText="生產日期" HtmlEncode="false" DataFormatString="{0:yyyy/MM/dd}" SortExpression="BillDate" > 
               ...
               <%--  <asp:BoundField DataField="StyleName" HeaderText="款式名稱" SortExpression="StyleName" > 
                <ItemStyle HorizontalAlign="Left" Width="12%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  --%>
                   <asp:BoundField DataField="SourceBillID" HeaderText="來源單號" SortExpression="SourceBillID" > 
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  
                   <asp:BoundField DataField="ProducePages" HeaderText="生產張數" SortExpression="ProducePages" > 
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  
                   <asp:BoundField DataField="StdPages" HeaderText="每卷張數" SortExpression="StdPages" > 
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  
                   <asp:BoundField DataField="Volumes" HeaderText="生產卷數" SortExpression="Volumes" > 
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  
                   <asp:BoundField DataField="StartLabelNo" HeaderText="標籤起始序號" SortExpression="StartLabelNo" > 
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  
                   <asp:BoundField DataField="EndLabelNo" HeaderText="標籤結束序號" SortExpression="EndLabelNo" > 
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  
                   <asp:BoundField DataField="ProductionUnitID" HeaderText="生產單位" SortExpression="ProductionUnitID" > 
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  
                   <asp:BoundField DataField="ScheduleBillID" HeaderText="排程單號" SortExpression="ScheduleBillID" > 
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  
                ...
                <asp:BoundField DataField="CheckUserName" HeaderText="營運覆核" SortExpression="CheckUserName" > 
                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" /> <HeaderStyle Wrap="False" /> 
                </asp:BoundField>  
   ...
   &nbsp;<asp:textbox id="txtPageNo" onkeypress="return regInput(this,/^\d+$/,String.fromCharCode(event.keyCode))"
            ...
            <asp:Literal ID="Literal3" runat="server" Visible="false" Text="未結案"></asp:Literal>
