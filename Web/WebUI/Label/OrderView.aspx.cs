...
using System.Data;
public partial class WebUI_Label_OrderView : BasePage
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            switch (e.Row.Cells[9].Text.Trim().ToLower())
            {
                case "false":
                    e.Row.Cells[9].Text = Literal11.Text;
                    break;
                case "true":
                    e.Row.Cells[9].Text = Literal10.Text;
                    break;
            }
            switch (e.Row.Cells[10].Text.Trim().ToLower())
            {
                case "false":
                    e.Row.Cells[10].Text = Literal11.Text;
                    break;
                case "true":
                    e.Row.Cells[10].Text = Literal10.Text;
                    break;
            }
        }
    }
