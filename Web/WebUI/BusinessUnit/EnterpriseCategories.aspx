<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnterpriseCategories.aspx.cs" Inherits="WebUI_BusinessUnit_EnterpriseCategories" %>
    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <Columns>
               ...
               <asp:TemplateField HeaderText="類別編號"  SortExpression="CategoryID">
                    <ItemTemplate>
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "EnterpriseCategoryView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "CategoryID") %>' Text='<%# DataBinder.Eval(Container.DataItem, "CategoryID")%>'></asp:HyperLink>                       
                    </ItemTemplate>
                  <ItemStyle Width="12%" Wrap="False" HorizontalAlign="Left"/>
                  <HeaderStyle Width="12%" Wrap="False" />
               </asp:TemplateField>
                <asp:BoundField DataField="CategoryName" HeaderText="類別名稱" 
                    SortExpression="CategoryName" >
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="CategoryEName" HeaderText="英文名稱" 
                    SortExpression="CategoryEName">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="LastModifyUserName" HeaderText="異動人員" 
                 ...
                 <asp:BoundField DataField="CheckUserName" HeaderText="覆核人員" 
                    SortExpression="CheckUserName" meta:resourcekey="BoundFieldResource20">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
