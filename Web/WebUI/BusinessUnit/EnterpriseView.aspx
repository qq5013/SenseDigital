    ...
    <title></title> 
        ...
        <script type="text/javascript">
            ...
            function ModifyRecord() {
                ...
                window.showModalDialog('EnterpriseModifyRecord.aspx?EnterpriseID=' + EnterpriseID + '&TitleName=' + TitleName, window, 'dialogHeight:220px;dialogWidth:400px;toolbar=no,status=yes,resizable=no');
                return false;
            }
        </script>
	</head>
       ...
       <table style="width: 100%; height: 20px;" class="OperationBar">
            ...
            <table class="maintable" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#ffffff" border="1" >				
					<tr>
						...
						<td width="35%" >&nbsp;
								<asp:textbox id="txtEnterpriseID" runat="server" CssClass="TextRead" ReadOnly="true"  Width="90%" MaxLength="6"></asp:textbox>
                        </td>
                    ...
                    <tr>
						...
						<td  width="35%">&nbsp;
								...
								&nbsp;<asp:Button ID="btnLabelRecord" OnClientClick="return ModifyRecord()" runat="server" CssClass="but" Text="標籤異動" Width="75px" />
								</td>
					</tr>
                    <tr>
