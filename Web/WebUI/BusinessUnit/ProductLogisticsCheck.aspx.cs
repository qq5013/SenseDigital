...
public partial class WebUI_BusinessUnit_ProductLogisticsCheck : BasePage
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            switch (e.Row.Cells[14].Text.ToString())
            {
                case "0":
                    e.Row.Cells[14].Text = Resources.Resource.Add;
                    break;
                case "1":
                    e.Row.Cells[14].Text = Resources.Resource.Modify;
                    break;
            }
        }
    }
    protected void btnCheck_Click(object sender, EventArgs e)
    {
        ...
        dal.ProductLogisticsCheck(this.txtEnterpriseID.Text, Session["User"].ToString());
        ...
        string Title = Resources.Resource.EP_ProductLogisticsCheckMessageTitle;
        string Content = Resources.Resource.EP_ProductLogisticsCheckMessageContent;
        ...
        Response.Redirect("ProductLogisticsChecks.aspx?FormID=" + Server.UrlEncode(FormID));
    }
}