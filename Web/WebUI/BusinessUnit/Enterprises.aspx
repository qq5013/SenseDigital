<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Enterprises.aspx.cs" Inherits="WebUI_BusinessUnit_Enterprises" %>
    ...
    <ProgressTemplate>            
        ...
        <div id="processMessage"> Loading...<br /><br />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="企業編號"  SortExpression="EnterpriseID" 
                   >
                    ...
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "EnterpriseView.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "EnterpriseID") %>' Text='<%# DataBinder.Eval(Container.DataItem, "EnterpriseID")%>'></asp:HyperLink>                  
                    </ItemTemplate>
                  <ItemStyle Width="12%" Wrap="False" HorizontalAlign="Left"/>
                  <HeaderStyle Width="12%" Wrap="False" />
               </asp:TemplateField>
                <asp:BoundField DataField="CategoryID" HeaderText="企業類別" 
                ...
                <asp:BoundField DataField="EnterpriseEName" HeaderText="企業英文名稱" 
                    SortExpression="EnterpriseEName">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                  <asp:BoundField DataField="UnionID" HeaderText="官方編號" 
                    SortExpression="UnionID">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                 
                 <asp:BoundField DataField="Phone" HeaderText="公司電話" 
                    SortExpression="Phone">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Fax" HeaderText="公司傳真" 
                    SortExpression="Fax">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
                 ...
                 <asp:BoundField DataField="WebUrl" HeaderText="公司網址" 
                    SortExpression="WebUrl">
                    <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                    <HeaderStyle Wrap="False" />
                </asp:BoundField>
