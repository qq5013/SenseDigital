<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductResumeChecks.aspx.cs" Inherits="WebUI_BusinessUnit_ProductResumeChecks" %>
                ...
                <asp:TemplateField HeaderText="(企業編號)"  SortExpression="EnterpriseID" 
                   >
                    ...
                    <asp:HyperLink id="HyperLink1" runat="server"                             
                            NavigateUrl='<%# "ProductResumeCheck.aspx?FormID=" + FormID + "&ID="+DataBinder.Eval(Container.DataItem, "EnterpriseID") %>'><%# DataBinder.Eval(Container.DataItem, "EnterpriseID")%></asp:HyperLink>                       
                    </ItemTemplate>
