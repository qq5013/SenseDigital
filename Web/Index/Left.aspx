<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Left.aspx.cs" Inherits="Index_Left" %>
<%@ Register src="../Controls/LeftBar.ascx" tagname="LeftBar" tagprefix="LBC" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title></title>
    <link href="../Styles/leftmenu.css?t=009" type="text/css" rel="Stylesheet"/>
...
<body style=" margin:0 0 0 0;" bgcolor="#F8FCFF"> 
    <form id="form1" runat="server">
    <div style="background-image:url(../images/leftmenu/left-bg.jpg);">
        <LBC:LeftBar ID="LeftBar" runat="server" />
    </div>
    </form>
    <script type="text/javascript">
        function Logout()
