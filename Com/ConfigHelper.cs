...
namespace Js.Com
{
    public sealed class ConfigHelper
    {
        ...
        public static void SetKeyValue(string path,string AppKey, string AppValue)
        {
            ...
            if (!System.IO.File.Exists(path + ".config"))//創建xml
            {
               ...
               XmlNode xmlnode = xDoc.CreateNode(XmlNodeType.XmlDeclaration, "", "");
                ...
                //加入另外一個元素
                XmlNode root = xDoc.SelectSingleNode("configuration");//查找<Employees>
                XmlElement xe1 = xDoc.CreateElement("appSettings");//創建一個<Node>節點
