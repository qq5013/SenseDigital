            ...
            foreach (DataRow row in dtb.Rows)
            {
                ...
                foreach (DataColumn col in dtb.Columns)
                {
                    if (col.DataType.Name == "DateTime")//日期
                    {
                        ...
                        drow.Add(col.ColumnName, Js.Com.PageValidate.GetDateTimeString((DateTime)row[col.ColumnName], "yyyy/MM/dd"));
                    }
                    ...
                    //{
                    //    drow.Add(col.ColumnName, Js.Common.PageValidate.GetYearMonthString("" + row[col.ColumnName], Js.Common.User.strDateFormat));
                    //}
                    else
